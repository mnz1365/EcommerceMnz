          ...
          <div className="col-md-8 order-md-1">
            ...
            <form className="needs-validation" noValidate="">
              ...
              <button
                ...
                type="button"
                className="group inline-flex w-full items-center justify-center rounded-md bg-indigo-500 px-3 py-2 text-lg font-semibold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-blue-600"
              >
                {t("confirmation")}
                <svg
